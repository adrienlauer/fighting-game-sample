 ...
 */
@Singleton
public final class J2SeKeyboardController1 implements org.jfge.spi.controller.Controller, KeyListener{
	/** The fighter. */
	 ...
	 */
	@Inject
	public J2SeKeyboardController1(
			...
			@Named("keyboard.controller1.start") int start, 
			@Named("keyboard.controller1.select") int select
	) {
		this.left = left;
		this.right = right;
		this.up = up;
		...
		key_pressed = new HashMap<>();
		key_released = new HashMap<>();
